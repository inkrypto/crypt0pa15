...
# the frequency of which a letter appears in a word
...
# function to score each character then subtracts the english character frequency (english - plaintext) 
def score_text(plaintext):
	...
	# penalize ugly char frequency. garbage gets a low score. english get a high score
